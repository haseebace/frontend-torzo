    ...
    <main className="min-h-dvh bg-white text-zinc-950">
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 md:px-10">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-zinc-600">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-zinc-900">3. Third-Party Services</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-zinc-900">4. Data Storage</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-zinc-900">5. Cookies</h2>
