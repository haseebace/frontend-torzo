      ...
      <section className="mx-auto max-w-3xl animate-page-fade-in px-4 py-12 md:px-10">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-text-subtle">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-foreground">1. Nature of Service</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-foreground">2. No Hosting</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-foreground">3. Search Results</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-foreground">4. Legal Compliance</h2>
            <p>
