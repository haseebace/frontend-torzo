...
export function AnimatedMenuToggle({
  ...
  return (
    <Button
      ...
      onClick={toggleMenu}
      className={cn(
        "relative z-[120] size-[50px] rounded-full bg-transparent text-foreground hover:bg-primary/5 hover:text-foreground focus-visible:ring-primary/15 active:scale-[0.96] md:hidden",
        className
      )}
    >
