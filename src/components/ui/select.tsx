  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="pointer-events-none size-4 text-muted-foreground transition-colors group-hover/select:text-foreground-strong" />
