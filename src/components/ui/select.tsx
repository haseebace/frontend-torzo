...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex min-h-9 w-full cursor-default items-center gap-2 rounded-md py-2 pr-9 pl-3 text-sm font-medium text-foreground-strong outline-hidden select-none transition-[background-color,color] duration-200 ease-out focus:bg-brand-surface focus:text-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
