...
Cohesion: 0.05
Nodes (43): AnimatedMenuToggle(), AnimatedMenuToggleProps, iconTransition, HomeContent(), ManageAccountForm(), ManageStatus, ProviderId, providers (+35 more)
...
Cohesion: 0.05
Nodes (39): code:block31 (X245A4XAIBGVM), code:block32 (https://api.real-debrid.com/oauth/v2/), code:block33 (https://api.real-debrid.com/oauth/v2/auth?client_id=ABCDEFGH), code:block34 (curl -X POST "https://api.real-debrid.com/oauth/v2/token" -d), code:block35 (https://api.real-debrid.com/oauth/v2/device/code?client_id=A), code:block36 ({), code:block37 (curl -X POST "https://api.real-debrid.com/oauth/v2/token" -d), code:block38 (https://api.real-debrid.com/oauth/v2/device/code?client_id=A) (+31 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (25): ResultSort(), TorrentMetricProps, TorrentResult, TorrentResultCard(), TorrentResultCardProps, formatDate(), buildPageUrl(), getMovieName() (+17 more)
...
Cohesion: 0.33
Nodes (5): metadata, plusJakartaSans, RootLayout(), sora, SiteFooter()
