...
6. `SiteNavbar()` - 14 edges
7. `API methods` - 14 edges
8. `Torrent Scraper API Guide` - 14 edges
...
Cohesion: 0.06
Nodes (43): metadata, plusJakartaSans, RootLayout(), sora, AnimatedMenuToggle(), AnimatedMenuToggleProps, iconTransition, ManageAccountForm() (+35 more)
...
Cohesion: 0.06
Nodes (33): cleanTitle(), DetailPage(), DetailPageProps, formatBytesFromBytes(), formatNumber(), formatPercent(), formatProviderLinkLabel(), getFileSizeDisplay() (+25 more)
...
Cohesion: 0.12
Nodes (20): ResultSort(), buildPageUrl(), getMovieName(), getSelectedProviders(), parsePageParam(), Props, ResultsPage(), ResultsPageProps (+12 more)
...
Cohesion: 0.14
Nodes (3): SiteNavbar(), metadata, Skeleton()
...
## Knowledge Gaps
- **269 isolated node(s):** `plusJakartaSans`, `sora`, `metadata`, `metadata`, `Props` (+264 more)
